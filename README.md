About python-ghostscript-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-ghostscript-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-ghostscript-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-ghostscript
# for installing globally
pixi global install python-ghostscript
```
...
It is possible to list all of the versions of `python-ghostscript` available on your platform:
...
```
pixi search python-ghostscript --channel conda-forge
```
